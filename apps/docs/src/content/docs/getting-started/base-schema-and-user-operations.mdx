...
Copy and paste the code snippets from each section below into your `db` (aliased to `#`) folder.

Then [migrate your database](#generate-and-apply-migrations) with your [configured `package.json` scripts](/getting-started/installation/#add-packagejson-scripts-for-migrations).
